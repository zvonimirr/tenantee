...
config :tenantee, TenanteeWeb.Endpoint,
  url: [host: "localhost"],
  render_errors: [
    formats: [html: TenanteeWeb.ErrorHTML, json: TenanteeWeb.ErrorJSON],
    layout: false
  ],
  pubsub_server: Tenantee.PubSub,
  live_view: [signing_salt: "A3kU1LEr"]
...
config :tenantee, Tenantee.Mailer, adapter: Swoosh.Adapters.Local
